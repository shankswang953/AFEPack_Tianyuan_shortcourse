...
After regeneration, copy the five files from their documented `output/`
locations into this directory. The mesh-heavy GIFs checked in here use GIF
frame-delta optimization to reduce repository size without changing their
pixel dimensions.
